package com.hepengju.hekele.base.common.service;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.hepengju.hekele.base.common.bo.Code;
import com.hepengju.hekele.base.common.dao.CodeMapper;
...
public class CodeService extends HeService<CodeMapper, Code> {
     ...
     * 清空并重新插入所有代码-开发环境使用
     */
    public JsonR truncateThenInsertAll(List<Code> codeList) {
        // 清空表
        codeMapper.truncate();
