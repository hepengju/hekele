...
public class CodeController {
    ...
    @ApiOperation("查询所有")
    @GetMapping("list")
    public R<Code> list(Long pageNum, Long pageSize, Code code) {
    ...
    @ApiOperation("根据主键查询")
    @GetMapping("getById")
    public R<Code> getById(@RequestParam String codeId) { return codeService.getRById(codeId);}

    @ApiOperation("根据多个类型代码查询, 返回代码值List")
    @GetMapping("getByTypeCodes")
    public R<Code> getByTypeCodes(@RequestParam("typeCode") String[] typeCodes) {
        return R.ok().addData(codeService.getByTypeCodes(typeCodes));
    }

    @ApiOperation("根据多个类型代码查询, 返回代码值Map")
    @GetMapping("getMapByTypeCodes")
    public R getMapByTypeCodes(@RequestParam("typeCode") String[] typeCodes) {
        return R.ok().addData(codeService.getMapByTypeCodes(typeCodes));
    }

    @ApiOperation("新增代码")
    @PostMapping("add")
    public R add(@Valid Code code) {
        code.setCodeId(null);
        validCode(code);
    ...
    @ApiOperation("删除代码")
    @PostMapping("delete")
    public R delete(@RequestParam("codeId") List<String> idList) {
    ...
    @ApiOperation("启用代码")
    @PostMapping("enable")
    public R enable(@RequestParam("codeId") List<String> idList) {
    ...
    @ApiOperation("禁用代码")
    @PostMapping("disable")
    public R disable(@RequestParam("codeId") List<String> idList) {
    ...
    public R truncateThenInsertAll(@RequestBody List<Code> codeList) {
