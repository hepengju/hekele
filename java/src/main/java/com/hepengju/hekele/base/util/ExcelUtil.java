...
public class ExcelUtil {
	...
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	// 读取值: readXXX (easyExcel),  getXXX(POI)
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	/**
	 * 读取工作表名称
	 */
	...
	public static Map<String, List<String>> readTitle(String fileName) {
		...
		dataMap.forEach((sheetName, data) -> result.put(sheetName, data.get(0)));
		return result;
	}
	public static List<String> readTitleFirstSheet(String fileName) {
		List<List<String>> sheetData = readCommon(fileName, null, 1, false, true, false).get("1");
		return sheetData.get(0);
	}
	public static List<String> readTitleBySheetName(String fileName, String sheetName) {
		List<List<String>> data = readCommon(fileName, sheetName, null, false, true, false).get(sheetName);
		return data == null ? null : data.get(0);
	}
	public static List<String> readTitleBySheetNameAndLastColumn(String fileName, String sheetName, Integer lastColumnIndex) {
	...
	public static List<List<String>> readDataFirstSheet(String fileName) {
		return readCommon(fileName, null, 1, false, false, true).get("1");
	}
	public static List<List<String>> readDataBySheetName(String fileName, String sheetName) {
		return readCommon(fileName, sheetName, null, false, false, true).get(sheetName);
	}
	public static List<List<String>> readDataFirstSheetAndOtherLimit(String fileName, int titleRow, int dataBeginRow, Integer lastColumnIndex) {
		return readCommon(fileName, null, 1, false, false, true, titleRow, dataBeginRow, lastColumnIndex).get("1");
	}
	public static List<List<String>> readDataBySheetNameAndOtherLimit(String fileName, String sheetName, int titleRow, int dataBeginRow, Integer lastColumnIndex) {
